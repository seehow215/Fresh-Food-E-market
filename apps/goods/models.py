...
class IndexAd(models.Model):
    ...
    Good Images
    """
    category = models.ForeignKey(GoodsCategory, verbose_name="类别", related_name="indexad", on_delete=models.CASCADE)
    goods = models.ForeignKey(Goods, verbose_name="商品", related_name="indexad", on_delete=models.CASCADE)
