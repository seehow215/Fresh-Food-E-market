# Generated by Django 3.0.6 on 2020-05-23 13:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('msg_type', models.IntegerField(choices=[(1, '留言'), (1, '投诉'), (1, '询问'), (1, '售后'), (1, '求购')], default=1, help_text='留言类型：1（留言），2（投诉），3（询问），4（售后），5（求购）', verbose_name='留言类型')),
